...
class LogOutProcessEvent implements AppEvent {
  const LogOutProcessEvent();
}
...
class RegisterEvent implements AppEvent {
...
class RegisterButtonEvent implements AppEvent {
